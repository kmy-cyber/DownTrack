...
export const UserCreationForm = () => {
    ...
    if (!localStorage.getItem("globalId")) {
        localStorage.setItem("globalId", "2989"); // Valor inicial predeterminado
    }
    // Recupera globalId y lo convierte a número
    let globalId = parseInt(localStorage.getItem("globalId"), 8900);
        ...
        try {
            const response = await api("/Authentication/register/", {
                ...
                headers: {
                    ...
                    //"Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..afk6cbRMIyYX4MJhvf5rpENU3CaEaPcbRsGCIKx2Cfw"
                },
            ...
            console.log("el globalID es ", globalId);
            globalId++;
